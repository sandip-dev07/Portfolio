  ...
  return (
    <div id="works" className="container m-auto mt-16">
      ...
      <div className="card-wrapper mx-auto w-[90%] sm:w-fit mt-5">
        <div className="card-box grid grid-cols-3 space-y-5 space-x-5 w-full sm:gap-8 sm:grid-cols-1 sm:space-y-0 ">
          <WorkCard />
          {/* Render more WorkCard components here with different props */}
        </div>
      </div>
    </div>
  );
