...
const Resume = () => {
  ...
  const internships = [
    ...
    },
    {
      ...
      description: `During my internship at Drafteq Engineering, I worked as a
                    Fullstack Developer focusing on the frontend development using
                    React.js and SCSS. I created interactive and user-friendly
                    interfaces and was responsible for building backend APIs using
                    Node.js, Express.js, and PostgreSQL for data storage and retrieval.`,
    },
  ];
  ...
  return (
    <div id="resume" className="container m-auto mt-16">
      ...
      {/* Carousel */}
      <div className="card-wrapper w-[90%] sm:w-full mt-5 flex flex-col items-center mx-auto">
        <div className="relative w-full flex items-center justify-center overflow-hidden">
          <div className="carousel-container w-[80%] sm:w-full overflow-hidden">
            <div
